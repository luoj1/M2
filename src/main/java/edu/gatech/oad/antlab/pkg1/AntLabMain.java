 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Yiheng Qi");
		  toPrint += p1.toString("yqi72");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Zhangqi Luo");
		  toPrint += p2.toString("zluo77");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Qigan Zhou");
		  toPrint += p3.toString("qzhou73");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Zexiu Wu");
                  toPrint += p4.toString("zwu349");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Shaohua Shen");
                  toPrint += p5.toString("sshen76");
